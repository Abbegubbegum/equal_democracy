  ...
  async function handleRate(stars: number) {
    ...
    try {
      const result = await apiClient<{
        ...
        method: "POST",
        body: JSON.stringify({ proposalId: proposal.id, rating: stars }),
      });
    ...
    <View style={{ width: "100%", height }}>
      ...
      <View
        style={[
          ...
          { paddingTop: insetTop + 60, paddingBottom: insetBottom + 110 },
        ]}
      >
...
function SubmitModal({
  ...
  async function pickImage() {
    ...
    if (status !== "granted") {
      setError("Appen behöver tillgång till ditt fotobibliotek");
      return;
    }
