...
import { BarChart3, Plus, Trash2, ArrowLeft, Play, Pause } from "lucide-react";
...
export default function SurveyAdminPage() {
  ...
  const handleDelete = async (id) => {
    if (
      !confirm(
        "Are you sure you want to delete this survey? All votes will be lost.",
      )
    ) {
      return;
    }
            ...
            surveys.map((survey) => (
              ...
              >
                ...
                <div className="p-4 space-y-2">
                  {survey.choices.map((choice) => {
                    const percentage =
                      survey.totalVotes > 0
                        ? Math.round(
                            (choice.voteCount / survey.totalVotes) * 100,
                          )
                        : 0;
                ...
                <div className="px-4 py-3 bg-gray-50 border-t text-sm text-gray-500 flex items-center justify-between">
                  <span>Total: {survey.totalVotes || 0} votes</span>
                  <span>
