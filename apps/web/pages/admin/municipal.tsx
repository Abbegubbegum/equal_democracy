      ...
      <header className="bg-slate-800 text-white p-6 shadow">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Kommunala Kallelser</h1>
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {new Date(s.meetingDate).toLocaleDateString("sv-SE")}
                          {" • "}
            ...
            <form onSubmit={handleExtract} className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  T.ex:
                  https://dok.vallentuna.se/file/demokrati/sammanträdeshandlingar/...
                </p>
              </div>

              <div>
                <label className="block text-sm font-medium mb-2">Kommun</label>
                <input
                  type="text"
                  value={municipality}
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-900">
                  ...
                  <ol className="list-decimal list-inside space-y-1">
                    <li>
                      AI:n läser PDF:en och filtrerar bort formalia (§1-8)
                    </li>
        ...
        {view === "review" && reviewSession && (
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-bold">Granska Ärenden</h2>
                <p className="text-sm text-gray-600">
