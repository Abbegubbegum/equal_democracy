...
export default function ArchivePage() {
  ...
  const fetchAllArchives = async () => {
    try {
      ...
      setMunicipalSessions(
        (municipalData.sessions || []).filter((s) => s.status !== "draft"),
      );
      ...
      setBudgetSessions(
        (budgetData.sessions || []).filter((s) => s.status !== "draft"),
      );
    } catch (error) {
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-center gap-2 text-xs text-gray-500">
                        ...
                        {budgetSession.endDate
                          ? new Date(budgetSession.endDate).toLocaleDateString(
                              "sv-SE",
                            )
                          : "Avslutad"}
                      </div>
        ...
        <section>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h2 className="text-xl font-bold text-gray-800">Kommunen</h2>
                <p className="text-sm text-gray-600">
        ...
        <section>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h2 className="text-xl font-bold text-gray-800">Idéer</h2>
                <p className="text-sm text-gray-600">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-600">
                        {archivedSession.participantCount > 0 && (
                          <div className="flex items-center gap-1">
                            ...
                            {archivedSession.participantCount} deltagare
                          </div>
                        )}
