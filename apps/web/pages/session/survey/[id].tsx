            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-sm">
              ...
              {showUserCount && (
                <div className="flex items-center gap-2 text-white font-medium whitespace-nowrap">
                  ...
                  <span>
                    {activeUserCount} {t("sessions.activeUsers") || "active"}
                  </span>
                </div>
              )}
              <button
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              backgroundColor: isExpired ? "#6b7280" : primaryColor,
            }}
          >
          ...
          <div>
            ...
            >
              {isExpired
                ...
                : t("ranking.timeRemaining") || "Time remaining"}
            </p>
            <p
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-3">
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  key={star}
                  className={`w-4 h-4 ${
                    star <= Math.round(proposal.averageRating || 0)
            ...
            <span className="text-xs text-gray-500">
              ({proposal.thumbsUpCount || 0} {t("ranking.ratings") || "ratings"}
              )
            </span>
          </div>
