...
export const sv = {
  ...
  admin: {
    ...
    requestedSessionsHelp:
      "Ange hur många sessioner du förväntar dig att behöva (1-50)",
    ...
    sessionsMovedMessage:
      "Sessionshantering har flyttats till en dedikerad sida för bättre organisation och tillgänglighet.",
  ...
  proposals: {
    ...
    noProposals:
      "Inga förslag än. Lägg gärna alla förslag först så ger vi dem stjärnor sen!",
  ...
  sessions: {
    ...
    checkBackLater:
      "Kom tillbaka senare eller kontakta en administratör för att skapa en session.",
    activeUsers: "aktiva",
  },
  ...
  poll: {
    ...
    checkBackLater:
      "Det finns ingen omröstning tillgänglig just nu. Kom tillbaka senare.",
    yourVote: "Din röst",
    votes: "röster",
    ...
    canChangeVote:
      "Du kan ändra din röst när som helst medan omröstningen är aktiv.",
  },
  ...
  budget: {
    ...
    infoAdjustAllocations:
      "Justera budgetallokeringar genom att dra reglagen eller ange nya belopp",
    ...
    infoMedianProposal:
      "Efter omröstningen blir medianen av alla förslag det gemensamma budgetförslaget",
    ...
    validation: {
      belowMinimum:
        "{category}: Beloppet {amount} mnkr är under minimum {minimum} mnkr",
      subcategoryBelowMinimum:
        "{category} - {subcategory}: Beloppet {amount} mnkr är under minimum {minimum} mnkr",
  ...
  email: {
    ...
    sessionResults: {
      ...
      noMajority: "Tyvärr fick inget förslag majoritet den här gången.",
      yesVotes: "ja-röster",
      noVotes: "nej-röster",
      electionPromise:
