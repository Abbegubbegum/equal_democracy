...
export const es = {
  ...
  admin: {
    ...
    sessionsMovedMessage:
      "La gestión de sesiones se ha trasladado a una página dedicada para una mejor organización y accesibilidad.",
  ...
  proposals: {
    ...
    noProposals:
      "Aún no hay propuestas. ¡Siéntete libre de agregar todas las propuestas primero, luego les daremos estrellas!",
  ...
  voting: {
    ...
    limitedVotingRights: "Derecho de voto limitado",
    oneVotePerSession:
  ...
  sessions: {
    ...
    checkBackLater:
      "Vuelve más tarde o contacta a un administrador para crear una sesión.",
    activeUsers: "activos",
  },
  ...
  poll: {
    ...
    checkBackLater:
      "No hay ninguna encuesta disponible en este momento. Por favor, vuelve más tarde.",
    yourVote: "Tu voto",
    votes: "votos",
    ...
    canChangeVote:
      "Puedes cambiar tu voto en cualquier momento mientras la encuesta esté activa.",
  },
