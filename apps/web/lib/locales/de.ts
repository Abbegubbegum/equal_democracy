...
export const de = {
  ...
  admin: {
    ...
    requestedSessionsHelp:
      "Geben Sie ein, wie viele Sitzungen Sie voraussichtlich benötigen (1-50)",
    sessionManagement: "Sitzungsverwaltung",
    sessionsMovedMessage:
      "Die Sitzungsverwaltung wurde auf eine eigene Seite verschoben, um bessere Organisation und Zugänglichkeit zu ermöglichen.",
  ...
  voting: {
    ...
    limitedVotingRights: "Eingeschränktes Stimmrecht",
    oneVotePerSession:
  ...
  sessions: {
    ...
    checkBackLater:
      "Kommen Sie später zurück oder kontaktieren Sie einen Administrator, um eine Sitzung zu erstellen.",
    activeUsers: "aktiv",
  },
  ...
  poll: {
    ...
    checkBackLater:
      "Derzeit ist keine Umfrage verfügbar. Bitte schauen Sie später wieder vorbei.",
    yourVote: "Ihre Stimme",
    votes: "Stimmen",
    totalVotes: "Stimmen insgesamt",
    selectToSeeResults:
      "Wählen Sie eine Option und senden Sie ab, um die Ergebnisse zu sehen",
    refreshResults: "Ergebnisse aktualisieren",
    submitting: "Wird gesendet...",
    updateVote: "Stimme ändern",
    submitVote: "Stimme abgeben",
    canChangeVote:
      "Sie können Ihre Stimme jederzeit ändern, solange die Umfrage aktiv ist.",
  },
  ...
  errors: {
    ...
    alreadySubmittedProposal:
      "Sie haben bereits einen Vorschlag in dieser Sitzung eingereicht.",
  },
  ...
  email: {
    ...
    sessionResults: {
      ...
      proposalsVotedThrough: "Diese Vorschläge wurden durchgestimmt:",
      noMajority: "Leider erhielt dieses Mal kein Vorschlag eine Mehrheit.",
      yesVotes: "Ja-Stimmen",
      noVotes: "Nein-Stimmen",
      electionPromise:
    ...
    adminApplication: {
      ...
      newApplication: "Ein neuer Benutzer hat sich als Admin beworben.",
      applicantName: "Name",
    ...
    adminDenial: {
      ...
      greeting: "Hallo {name},",
      denied: "Leider wurde Ihre Bewerbung als Admin abgelehnt.",
      explanation:
