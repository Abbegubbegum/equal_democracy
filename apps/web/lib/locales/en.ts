...
export const en = {
  ...
  proposals: {
    ...
    noProposals:
      "No proposals yet. Feel free to add all proposals first, then we'll give them stars later!",
  ...
  poll: {
    ...
    checkBackLater:
      "There is no poll available at the moment. Please check back later.",
    yourVote: "Your vote",
    votes: "votes",
    ...
    canChangeVote:
      "You can change your vote at any time while the poll is active.",
  },
  ...
  budget: {
    ...
    infoAdjustAllocations:
      "Adjust budget allocations by dragging the sliders or entering new amounts",
    ...
    infoMedianProposal:
      "After the vote is over, the median of all proposals becomes the joint budget proposal",
    ...
    validation: {
      belowMinimum:
        "{category}: Amount {amount} MSEK is below minimum {minimum} MSEK",
      subcategoryBelowMinimum:
        "{category} - {subcategory}: Amount {amount} MSEK is below minimum {minimum} MSEK",
  ...
  email: {
    loginCode: {
      ...
      useCodeBelow: "Use the code below to log in. It is valid for 10 minutes.",
    ...
    sessionResults: {
      ...
      noMajority: "Unfortunately, no proposals achieved a majority this time.",
      yesVotes: "yes votes",
      noVotes: "no votes",
      electionPromise:
