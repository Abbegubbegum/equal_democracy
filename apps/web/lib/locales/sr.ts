...
export const sr = {
  ...
  admin: {
    ...
    requestedSessionsHelp:
      "Unesite koliko sesija očekujete da će vam biti potrebno (1-50)",
    sessionManagement: "Upravljanje sesijama",
    sessionsMovedMessage:
      "Upravljanje sesijama je premešteno na posebnu stranicu radi bolje organizacije i pristupačnosti.",
  ...
  proposals: {
    ...
    noProposals:
      "Još nema predloga. Slobodno dodajte sve predloge prvo, pa ćemo im onda dati zvezde!",
  ...
  sessions: {
    ...
    checkBackLater:
      "Vratite se kasnije ili kontaktirajte administratora da kreira sesiju.",
  ...
  poll: {
    ...
    canChangeVote:
      "Možete promeniti svoj glas u bilo kom trenutku dok je anketa aktivna.",
  },
  ...
  email: {
    loginCode: {
      ...
      useCodeBelow: "Koristite kod ispod da se prijavite. Važeći je 10 minuta.",
    ...
    adminApplication: {
      ...
      newApplication: "Novi korisnik se prijavio da postane administrator.",
      applicantName: "Ime",
