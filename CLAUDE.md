...
│   ├── VotingDebateSection.tsx # För/emot debate for a Question, rendered inline (not a modal) below VotingQuestionCard on Rösta — self-contained, always visible while a question is selected
